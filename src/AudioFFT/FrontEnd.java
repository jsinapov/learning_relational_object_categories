...
public class FrontEnd extends BaseDataProcessor  {
     ...
     */
    public void register(String name, Registry registry1) throws PropertyException {
        super.register(name, (edu.cmu.sphinx.util.props.Registry) registry1);
        try {
			registry1.bind(PROP_PIPELINE, (Remote) PropertyType.COMPONENT_LIST);
