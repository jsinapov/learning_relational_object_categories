...
public class RaisedCosineWindower{
    ...
    public void setPredecessor(StreamDataSource file) {
    ...
    //public static final float PROP_WINDOW_SIZE_MS_DEFAULT = 0.5f;
    /**
    ...
    public void initialize() {
        alpha = PROP_ALPHA_DEFAULT;
        windowSizeInMs = PROP_WINDOW_SIZE_MS_DEFAULT;
        windowShiftInMs = PROP_WINDOW_SHIFT_MS_DEFAULT;
