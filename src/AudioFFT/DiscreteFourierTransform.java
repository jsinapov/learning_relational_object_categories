 ...
 * {@link #PROP_NUMBER_FFT_POINTS}. The length of the returned power spectrum
 * is the number of FFT points, divided by 2, plus 1. Since the input signal is
...
public class DiscreteFourierTransform{
    ...
    private String name;
    private RaisedCosineWindower predecessor;
    private Timer timer;
    
    public void setPredecessor(RaisedCosineWindower predecessor) {
	...
	/**
	 * The name of the SphinxProperty for the number of points in the Fourier
	 * Transform.
	 */
	...
	/**
	 * 
	 * @param numFFTPoints must be 2^n + 1 where n is an integer.
	 */
	public void initialize(int numFFTPoints){
		numberFftPoints = (numFFTPoints - 1) * 2;//!!!!!!
		isNumberFftPointsSet = (numberFftPoints != -1);
		this.timer = Timer.getTimer(name);
		if (isNumberFftPointsSet) {
			initializeFFT();
	...
	private DoubleData process(DoubleData input)
		 ...
		 */
		DoubleData output = new DoubleData(outputSpectrum, input
				.getSampleRate(), input.getCollectTime(), input
