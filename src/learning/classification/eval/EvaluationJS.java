 ...
 */
public class EvaluationJS implements Serializable, Summarizable, RevisionHandler {
  ...
  protected EvalDelegate m_delegate;
  ...
  public EvaluationJS(Instances data) throws Exception {
    m_delegate = new EvalDelegate(data);
  }

  public EvaluationJS(Instances data, CostMatrix costMatrix) throws Exception {
    m_delegate = new EvalDelegate(data, costMatrix);
  }
  ...
  public boolean equals(Object obj) {
    if (obj instanceof EvaluationJS) {
      obj = ((EvaluationJS) obj).m_delegate;
    }
